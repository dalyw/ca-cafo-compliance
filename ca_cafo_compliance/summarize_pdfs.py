...
print(f"Total facilities with the wrong number of manifests flagged in auto: {len(manual_counts[manual_counts['manifest_count'] != manual_counts['manual_count']])}")
# give as %
percent_wrong = len(manual_counts[manual_counts['manifest_count'] != manual_counts['manual_count']]) / len(manual_counts) * 100
...
false_positive_count = (false_positive_rows['manifest_count'] - false_positive_rows['manual_count']).sum()
percent_false_positives = (false_positive_count / manual_count_total * 100) if manual_count_total > 0 else 0
